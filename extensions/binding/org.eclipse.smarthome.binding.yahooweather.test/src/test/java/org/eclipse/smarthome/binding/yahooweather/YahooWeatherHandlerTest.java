...
/**
* Tests cases for {@link YahooWeatherHandler}. The tests provide mocks for supporting entities using Mockito.
*
* @author AchimHentschel - Initial contribution
*/
public class YahooWeatherHandlerTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new YahooWeatherHandler(thing);
