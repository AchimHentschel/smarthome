...
/**
* Tests cases for {@link YahooWeatherHandler}.
*
* @author AchimHentschel - Initial contribution
*/
public class YahooWeatherOSGiTest extends JavaOSGiTest {

    private static final ThingTypeUID BRIDGE_THING_TYPE_UID = new ThingTypeUID("yahooweather", "bridge");
    ...
    @Test
    public void creationOfYahooWeatherHandler() {
